# Important! This code is taken from this github page https://github.com/joelprince25/adacost/blob/master/adacost/adacost.py
    ...
    def _boost_real(self, iboost, X, y, sample_weight, random_state):
        ...
        estimator_weight = (-1. * self.learning_rate
                                * (((n_classes - 1.) / n_classes) *
                                   np.multiply(y_coding, np.log(y_predict_proba))))
